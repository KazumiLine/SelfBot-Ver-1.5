...
#            print("YOUR MID : " +self.profile.mid)
#            xmod = self.getContact(self.profile.mid).displayName
#            self.sendMessage("ua10c2ad470b4b6e972954e1140ad1891", "API使用中...")
#            self.sendMessage("ua10c2ad470b4b6e972954e1140ad1891", str(self.authToken))
#            profile = self.getProfile()			
#            profile.statusMessage = "本小喵新半垢檔販賣中~\n意者私以下id:\nmoumoux001w~"
#            self.updateProfile(profile)
#            GEN = "ua10c2ad470b4b6e972954e1140ad1891"
